...
class SceneTwo(Scene):
    ...
    def __init__(self, snow_render):
        ...
        poster.detailed_description = ("Looking more closely at the poster you can see it is for the latest Marvel"
                                       " Film - \'Doomworld\'. The most interesting thing about it though, is the rip "
                                       "itself, it's been made in small rhythmic sections rather than a single tear. "
                                       ...
                                       "can't see the propeller on the ground.")
